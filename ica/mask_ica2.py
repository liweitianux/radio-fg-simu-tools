...
#            print whitened_source.shape
        ...
        ficad=mdp.nodes.FastICANode(approach='symm',g='gaus', guess=guess_matrix,fine_g='gaus', mu=0.1, stabilization=True, sample_size=1, fine_tanh=1, max_it=1000000, max_it_fine=100000, failures=5000, limit=0.0000001, verbose=False, whitened=True)
